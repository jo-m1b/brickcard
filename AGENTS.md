...
| `src/js/welcome-dialog.js` | First-visit welcome modal (intro + LEGO disclaimer; off-local telemetry ask when no choice is stored); `import()` on home |
