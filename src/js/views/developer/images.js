  ...
  host.innerHTML = `
    <section class="panel styleguide no-print">
      <header class="styleguide-header">
        <p class="styleguide-kicker">${linkMarkup("Styleguide", { href: "#/developer" })} / Images</p>
        <h1 class="view-title">Champs image</h1>
      </header>
      ...
      <p class="styleguide-intro">
        ...
        (badges zoom / alignement, reset, supprimer, télécharger).
      ...
      <p class="styleguide-back">
        ...
        ·
        ${linkMarkup("Couleurs", { href: "#/developer/colors" })}
        ·
