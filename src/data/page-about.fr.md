...
- **Autocomplétion Rebrickable** : un super autocompléteur du catalogue pour créer des cartes en un éclair ;)
...
La licence MIT s’applique uniquement au code source et à la documentation de Brickcard.<br>Voir le fichier [LICENSE](https://github.com/jo-m1b/brickcard/blob/main/LICENSE).

Les logos de thèmes par défaut, le logo Rebrickable et les marques tierces ne sont **pas** sous licence MIT.<br>Voir [NOTICE](https://github.com/jo-m1b/brickcard/blob/main/NOTICE).

Les polices utilisées sont sous SIL Open Font License.
