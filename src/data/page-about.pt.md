...
Crie cartões, imprima, plastifique e coloque numa capa transparente com um set cuja caixa desapareceu. Meus filhos adoram — e isso evita desembalar o set errado por engano :P
...
Procure primeiro nas issues e discussões existentes. Faço o possível para responder, mas nem sempre tenho tempo.

### Bugs e pedidos de recursos

Publique-os em [GitHub Issues](https://github.com/jo-m1b/brickcard/issues).

### Suporte e discussão geral

Use [GitHub Discussions](https://github.com/jo-m1b/brickcard/discussions).
...
- **Fonte Inter**: (texto dos cartões) desenhada por [Rasmus Andersson](https://rsms.me), repositório [github.com/rsms/inter](https://github.com/rsms/inter)
